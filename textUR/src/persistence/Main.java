...
public class Main {
	...
	public static void main(String args[])
	{
		...
		File file1 = new File("file1",package1,"public class file1 {\n\n}");
		File file2 = new File("file2",package1,"public class file1 {\n\n}");
		File file3 = new File("file3",package2,"public class file3 {\n\n}");
